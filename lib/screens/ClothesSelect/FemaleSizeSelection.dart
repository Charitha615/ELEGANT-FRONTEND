...
// void main() {
//   runApp(new fsizeselector());
// }

class fsizeselector extends StatelessWidget {
  String clothType;
  int myshoulderwidth;
  int myhip;
  int myleglength;
  fsizeselector(@required this.clothType, @required this.myshoulderwidth,
...
class MyHomePage extends State {
  ...
  int myhip;
  int myleglength;
  String smallsize = 'tshirtFemalesmall';
  String mediumsize = 'tshirtFemale2medium';
  ...
  Widget build(BuildContext context) {
    if (clothType == 'shirts') {
      if (myshoulderwidth >= 14 && myshoulderwidth <= 15) {
        RecommendedSize = 'S';
        smallsize = 'tshirtFemale2medium';
        mediumsize = 'tshirtFemale3large';
        largesize = 'tshirtFemale4xlarge';
      } else if (myshoulderwidth >= 16 && myshoulderwidth <= 17) {
        RecommendedSize = 'M';
        smallsize = 'tshirtFemale1small';
        mediumsize = 'tshirtFemale2medium';
        largesize = 'tshirtFemale3large';
      } else if (myshoulderwidth >= 18 && myshoulderwidth <= 20) {
        RecommendedSize = 'L';
        smallsize = 'tshirtFemale0xsmall';
        mediumsize = 'tshirtFemale1small';
        largesize = 'tshirtFemale2medium';
      } else {}
    } else if (clothType == 'shorts') {
      if (myhip >= 27 && myhip <= 29) {
        RecommendedSize = 'S';
        smallsize = 'shortpantFemale2medium';
        mediumsize = 'shortpantFemale3large';
        largesize = 'shortpantFemale4xlarge';
      } else if (myhip >= 30 && myhip <= 32) {
        RecommendedSize = 'M';
        smallsize = 'shortpantFemale1small';
        mediumsize = 'shortpantFemale2medium';
        largesize = 'shortpantFemale3large';
      } else if (myhip >= 33 && myhip <= 36) {
        RecommendedSize = 'L';
        smallsize = 'shortpantFemale0xsmall';
        mediumsize = 'shortpantFemale1small';
        largesize = 'shortpantFemale2medium';
      } else {}
    } else if (clothType == 'pants') {
      if (myhip >= 27 && myhip <= 29) {
        RecommendedSize = 'S';
        smallsize = 'pantFemale2medium';
        mediumsize = 'pantFemale3large';
        largesize = 'pantFemale4xlarge';
      } else if (myhip >= 30 && myhip <= 32) {
        RecommendedSize = 'M';
        smallsize = 'pantFemale1small';
        mediumsize = 'pantFemale2medium';
        largesize = 'pantFemale3large';
      } else if (myhip >= 33 && myhip <= 36) {
        RecommendedSize = 'L';
        smallsize = 'pantFemale0xsmall';
        mediumsize = 'pantFemale1small';
        largesize = 'pantFemale2medium';
      } else {}
    } else {}
    return Scaffold(
      appBar: AppBar(
